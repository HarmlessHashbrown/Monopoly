...
board={'Start':{'image':'./images/Start.png','price':20},
       'London':{'image':'./images/Britain.png','price':28},
       'Paris':{'image':'./images/France.png','price':25},
       'Rome':{'image':'./images/Italy.png','price':27},
       'Lucky_Card_E':{'image':'./images/Lucky_card.png','price':0},
       'Bern':{'image':'./images/Switzerland.png','price':29},
       'Berlin':{'image':'./images/Germany.png','price':31},
       'Island':{'image':'./images/island.png','price':32},
       'Mogadishu':{'image':'./images/Somalia.png','price':27},
       'Rabat':{'image':'./images/Moroco.png','price':30},
       'Accra':{'image':'./images/Ghana.png','price':28},
       'Concord':{'image':'./images/Concord.jpg','price':35},
       'Antananarivo':{'image':'./images/Madagascar.png','price':33},
       'Nairobi':{'image':'./images/Kenya.png','price':20},
       'World_Bank':{'image':'./images/World_Bank.jpg','price':10},
       'Washington_DC':{'image':'./images/USA.png','price':45},
       'Brasilia':{'image':'./images/Brazil.png','price':39},
       'Mexico_City':{'image':'./images/Mexico.png','price':37},
       'Lucky_Card_NS':{'image':'./images/Lucky_card.png','price':0},
       'Otawa':{'image':'./images/Canada.png','price':42},
       'Buenos_Aires':{'image':'./images/Argentina.png','price':45},
       'Rocket':{'image':'./images/Rocket.png','price':20},
       'Beijing':{'image':'./images/China.png','price':60},
       'Abudabi':{'image':'./images/UAE.png','price':65},
       'Manila':{'image':'./images/Philipines.png','price':50},
       'Lucky_Card_A':{'image':'./images/Lucky_card.png','price':0},
       'Tokyo':{'image':'./images/Japan.png','price':55},
       'Seoul' :{'image':'./images/South_Korea.png','price':100}}
